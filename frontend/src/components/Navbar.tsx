    ...
    <header className="sticky top-0 z-40 w-full bg-ivory-100/80 backdrop-blur-md border-b border-slate-900/10 transition-colors">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <nav className="flex items-center space-x-6 text-sm font-medium">
          ...
          <Link
            href="/leaderboard"
            className="text-slate-700 hover:text-slate-900 transition-colors tracking-tight font-semibold flex items-center space-x-1 bg-amber-500/10 px-2.5 py-1 rounded-md border border-amber-500/20"
          >
